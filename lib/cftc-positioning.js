...
export async function buildPositioning(){
  ...
  try{
    ...
    const crude=commodityComponent(dis,['CRUDE OIL','WTI'],'Crude');
    const copper=commodityComponent(dis,['COPPER'],'Copper');
    const corn=commodityComponent(dis,['CORN'],'Corn');
    const wheat=commodityComponent(dis,['WHEAT'],'Wheat');
    ...
    const soy=commodityComponent(dis,['SOYBEAN'],'Soybeans');
    const sugar=commodityComponent(dis,['SUGAR'],'Sugar');
    const coffee=commodityComponent(dis,['COFFEE'],'Coffee');
