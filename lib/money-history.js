...
// Keep the asset path statically visible to Vercel's serverless file tracer.
// The previous path.resolve/fileURLToPath construction worked in the repository
// and GitHub Pages build, but the CSV was not reliably bundled into /api/history.
const SOURCE = new URL('../research/global-money-v2/latest/global_money_v2.csv', import.meta.url);
