export const MONEY_NOWCAST = {
  ...
  "comparison_reference": {
    ...
    "guardrail": "This fixed February comparator is retained only for continuity of the country-level directional nowcast overlay. It is not the active Money V2 Core. Scheduled refresh never changes frozen weights, FX-neutral methodology, lags, horizons, thresholds, train/validation split or FDR rules and never auto-promotes CORE."
  },
  "refresh": {
    "mode": "SCHEDULED_VALIDATED_REFRESH",
    "last_verified_at": "2026-08-24T08:29:10Z",
    ...
    "last_result": {
      ...
      "china": {
        ...
        "source_search_sha256": "b2240226b8233a17fc8cd4f2b7eb7539ae3b9069754ae5b635b69a1a7b4a8f15"
      }
    }
  },
  "blocks": {
  ...
  "usd_translation": {
    ...
    "latest_verified": "2026-08-14",
    "pct_change_since_core": 0.92,
    "translation": "NEUTRAL",
...
export function summarizeNowcast() {
  ...
  return {
    ...
    methodology: 'Unweighted directional freshness overlay versus the fixed February-2026 historical comparator. This is separate from the active Money V2 Core.'
  };
}
